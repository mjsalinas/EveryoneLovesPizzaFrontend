...
export class InsumosregistryComponent implements OnInit {
  ...
  constructor(
    ...
    public categoryservices: CategoriasService
  ) {}
  ...
  getallinsumos() {
    this.insumoservice.getInsumosAll().subscribe((res) => {
      console.log('res :>> ', res);
  ...
  getallcategories() {
    this.categoryservices.getCategoriasAll().subscribe((res) => {
  ...
  Editinsumo(form: NgForm) {
    ...
    this.insumoservice.updateInsumo(form.value).subscribe((res) => {
      console.log('res :>> ', res);
    });
  ...
  addnewinsumo(form2: NgForm) {
    ...
    this.insumoservice.saveNewInsumos(form2.value).subscribe((res) => {
      console.log('res :>> ', res);
    });
    form2.reset();
  }
  ...
  deleteinsumo(id: string, form3: NgForm) {
    this.insumoservice.deleteInsumo(id).subscribe((res) => {
      console.log('res :>> ', res);
    });
